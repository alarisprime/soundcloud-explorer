...
**Step 3.** Import required React Bootstrap components within ```SoundCloudExplorerApp.js``` file or your custom component files.
...
Now you are ready to use the imported React Bootstrap components within your component hierarchy defined in the render method. Here is an example [SoundCloudExplorerApp.js](https://github.com/manavsehgal/react-eshop/blob/master/src/SoundCloudExplorerApp.js) redone using React Bootstrap.
...
src/SoundCloudExplorerApp.js:3
  3: import logo from './logo.svg';
                      ^^^^^^^^^^^^ ./logo.svg. Required module not found

src/SoundCloudExplorerApp.js:4
  4: import './App.css';
